...
% Initial gain
c.logg_0mu = log(.05); % ! go through exp() in tapas_kf_trans
c.logg_0sa = .02;% !! gain has to be between 0 and 1 !! (https://www.youtube.com/watch?v=fpRb1sjFz_M)
...
% Process variance
c.ommu = -7;% this will be exponentiated in tapas_kf
c.omsa = 10;

% Pi_u
% Fix this to zero (no perceptual uncertainty) by setting
